...
# Area para detecção dos checkpoints
x1_img_sinalizacao_esq, x2_img_sinalizacao_esq = 0, 320
...
classificador_igreja = cv2.CascadeClassifier('/home/pi/Projetos/Atena/Classificadores/cascade_pare.xml')
nome_plc_igreja = "Igreja"
