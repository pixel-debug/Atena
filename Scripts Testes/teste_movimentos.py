...
try:
	while (True):
		...
		motor.movimento_direita(var.velEmergencia, controle_velocidade_direita, controle_velocidade_esquerda)
		time.sleep(2)	
		motor.parar_movimento(controle_velocidade_direita, controle_velocidade_esquerda)
		time.sleep(0.8)


		motor.movimento_esquerda(var.velEmergencia, controle_velocidade_direita, controle_velocidade_esquerda)
		time.sleep(2)	
		motor.parar_movimento(controle_velocidade_direita, controle_velocidade_esquerda)
		time.sleep(0.8)
		...
		motor.movimento_tras(controle_velocidade_direita, controle_velocidade_esquerda)
		time.sleep(1)
		motor.parar_movimento(controle_velocidade_direita, controle_velocidade_esquerda)
		time.sleep(0.8)
finally:
